    ...
    <div class="flex-1 overflow-auto">
      ...
      <nut-form :model-value="form" ref="ruleForm">
        ...
        <nut-form-item
          class="jx-form-item"
          label="电池有效期"
          v-if="form.type === 'battery'"
          required
        >
          <nut-input
            :border="false"
            class="nut-input-text"
            v-model="form.batteryInvalidDate"
            @click="datePop.open('batteryInvalidDate')"
            readonly
        ...
        <nut-form-item
          class="jx-form-item"
          label="电极片有效期"
          v-if="form.type === 'electrode'"
          required
        >
          <nut-input
            :border="false"
            class="nut-input-text"
            v-model="form.electrodeInvalidDate"
            @click="datePop.open('electrodeInvalidDate')"
            readonly
