<template>
  <div class="wh-full flex-col useReport overflow-hidden bg-hex-fff">
          ...
          <nut-form-item class="jx-form-item" label="安装区域" required>
            ...
            >
              <nut-cascader
                ...
                @pathChange="region.pathChange"
                lazy
                :lazyLoad="region.lazyLoad"
              ></nut-cascader>
              <nut-cell>
                <nut-button
                  style="width: 100%"
                  type="primary"
                  @click="region.confirm"
                  >确定</nut-button
                >
              </nut-cell>
            </nut-popup>
    ...
    <nut-popup position="bottom" v-model:visible="selectPop.show">
      <nut-picker
        v-model="selectPop.value"
        :columns="selectPop.columns"
        @confirm="selectPop.confirm"
...
import {
  useDeviceBySearialNumber,
} from "~/composables/use-device-searialNumber";
